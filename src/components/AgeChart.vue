<template>
  <div class="bg-white p-5 rounded-2xl shadow-md hover:shadow-lg transition">
    ...
    <canvas id="ageChart" width="400" height="250" style="max-height: 250px;"></canvas>
  </div>
</template>
...
onMounted(() => {
  ...
  chart = new Chart(ctx, {
    ...
    data: {
      ...
      datasets: [{ data: props.data || [0,0,0,0], backgroundColor: ['#34d399','#60a5fa','#fbbf24','#f87171'], borderWidth: 0 }]
    },
